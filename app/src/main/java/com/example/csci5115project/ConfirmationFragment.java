...
public class ConfirmationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_confirmation, container, false);

        Button logMenu = (Button) root.findViewById(R.id.logMenu);
        logMenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                FragmentUtil.replaceFragment(getActivity(), new LogFragment());
            }
        });
